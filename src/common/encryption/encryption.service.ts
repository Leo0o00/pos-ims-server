...
export class EncryptionService {
    ...
    encrypt(text: string): string {
        ...
        const cipher = crypto.createCipheriv(this.ALGORITHM, Buffer.from(this.encryptionKey, 'base64'), iv);
    ...
    decrypt(text: string): string {
        ...
        const decipher = crypto.createDecipheriv(this.ALGORITHM, Buffer.from(this.encryptionKey, 'base64'), iv);
